# session-state-isolation Specification

## Purpose

Define per-session ownership, isolation and browser-verifiable capacity boundaries for editor state,
interactions and runtime compositor resources.
