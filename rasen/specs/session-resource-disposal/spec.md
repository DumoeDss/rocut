# session-resource-disposal Specification

## Purpose

Define serialized session lifecycle transitions, quiescent suspend/resume behavior, complete owner-scoped release across five browser resource classes, shared-GPU last-owner teardown, and non-vacuous browser leak evidence.
