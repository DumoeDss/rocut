...
DISPOSITIONS = {
    ...
    "BOUNDARIES.md:1159": "§14's sweep narration naming the term list (`1.0`, `stable`, ...) — a mention, not a claim",
    "BOUNDARIES.md:1160": "§14's sweep narration naming the term list (... `production-ready`, `semver`, `GA`) — a mention, not a claim",
    "BOUNDARIES.md:1163": "§14's sweep narration quoting the ordinary-English 'stable' dispositions — a mention, not a claim",
    "BOUNDARIES.md:1164": "§14's sweep narration describing the numeric `1.0` literal dispositions — a mention, not a claim",
    "BOUNDARIES.md:1166": "§14's sweep narration (Gabon ISO-code sentence + the closing 'zero hits' denial) — mentions, not claims",
    "BOUNDARIES.md:1167": "§14's closing sentence that zero hits make a `1.0`/GA claim — the sweep's own result statement, a denial not a claim",
